...
const Galerry = () => {
  const dolls = [
    ...
    { id: 10, name: 'Boneka Pikachu', images: boneka10, price: 'Rp 120.000' },
    { id: 11, name: 'Boneka Cinnamoroll', images: boneka11, price: 'Rp 120.000' },
    { id: 12, name: 'Boneka Hiu', images: boneka12, price: 'Rp 120.000' },
  ];

  const handleOrder = (dollName) => {
    alert(`Anda telah memesan ${dollName}. Terima kasih!`);
  };
